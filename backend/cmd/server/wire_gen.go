...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	teamBalanceRepository := repository.NewTeamBalanceRepository(db)
	teamBalanceService := service.NewTeamBalanceService(teamBalanceRepository)
	billingCacheService := service.ProvideBillingCacheService(billingCache, userRepository, userSubscriptionRepository, apiKeyRepository, userRPMCache, userGroupRateRepository, configConfig, serviceUserPlatformQuotaRepository, teamBalanceService)
	...
	quotaHandler := handler.NewQuotaHandler(adminService)
	teamBalanceHandler := handler.NewTeamBalanceHandler(teamBalanceService)
